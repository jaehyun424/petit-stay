...
const testimonials = [
  { nameKey: 'testimonial1Name', roleKey: 'testimonial1Role', quoteKey: 'testimonial1Quote', rating: 5 },
  { nameKey: 'testimonial2Name', roleKey: 'testimonial2Role', quoteKey: 'testimonial2Quote', rating: 5 },
  { nameKey: 'testimonial3Name', roleKey: 'testimonial3Role', quoteKey: 'testimonial3Quote', rating: 5 },
];
...
export function TestimonialSection() {
  ...
  return (
    <section id="testimonials" className="testimonial-section section-padded section-dark">
      <ScrollReveal>
